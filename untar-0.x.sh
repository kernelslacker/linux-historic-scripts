...
bzcat ../../0.x/0.99.11-patch1.diff.bz2 | patch -p1 -s
cd ..
...
bzcat ../../0.x/0.99.12-patch1.diff.bz2 | patch -p1 -s
cd ..
...
cd linux-0.99.13k
bzcat ../../0.x/0.99.13k.diff.bz2 | patch -p1 -s
cd ..
...
cd linux-1.0pre1
bzcat ../../0.x/1.0pre1.diff.bz2 | patch -p1 -s
cd ..
echo patching to 1.0alpha
cp -rl linux-1.0pre1 linux-1.0alpha
cd linux-1.0alpha
bzcat ../../0.x/1.0alpha.diff.bz2 | patch -p1 -s
cd ..
